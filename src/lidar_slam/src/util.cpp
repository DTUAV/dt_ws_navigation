...
int Util::DecompressString(const std::string& src, std::string& dst) {
...
int Util::StreamCompressString(const std::string& src, std::string& dst, int compressionlevel) {
...
int Util::StreamDecompressString(const std::string& src, std::string& dst, int compressionlevel) {
